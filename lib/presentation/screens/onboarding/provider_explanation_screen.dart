...
class _ProviderExplanationScreenState extends State<ProviderExplanationScreen>
                          ...
                          children: [
                            ...
                            Column(
                              children: [
                                ...
                                Text(
                                  'Get a steady stream of customers who need your services.',
                                  textAlign: TextAlign.center,
                                  style: TextStyle(
                                    fontSize: 15.5,
                            ...
                            // 🔹 Separate cards like customer screen
                            Column(
                              children: [
                                _buildServiceCard(
                                  context: context,
                                  cardColor: cardColor,
                                  icon: Icons.people,
                                  title: 'Find more customers',
                                  subtitle:
                                      'Reach people near you who are searching for your service.',
                                ),
                                ...
                                _buildServiceCard(
                                  ...
                                  subtitle:
                                      'Accept more bookings and grow your income.',
                                ),
                                const SizedBox(height: 12),
                                _buildServiceCard(
                                  context: context,
                                  ...
                                  subtitle:
                                      'Choose when you are available and what jobs you accept.',
                                ),
                              ],
                            ),
  ...
  // 🔹 Separate card widget (same idea as customer screen)
